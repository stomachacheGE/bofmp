...
data_folder =  project_folder + '/data_diagonal_false_conditioanl_true'
...
min_traj_length =  0 # in meters
max_traj_length = 10  # in meters
...
# TRAINING OUPUT
experiment_name = '03_DIAGONAL_FALSE_CONDITIONAL_TRUE'
